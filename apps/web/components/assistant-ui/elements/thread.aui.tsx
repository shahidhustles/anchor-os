...
const EditComposer: FC = () => {
  return (
    ...
    >
      <ComposerPrimitive.Root className="aui-edit-composer-root border-border/60 ms-auto flex w-full max-w-[85%] cursor-text flex-col rounded-(--composer-radius) border bg-(--composer-bg)">
        <ComposerPrimitive.Input
