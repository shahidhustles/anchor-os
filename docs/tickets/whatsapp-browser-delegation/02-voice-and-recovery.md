...
- Keep one socket and one listener across development reloads. Reconnect after recoverable failures, but stop after logout or connection replacement. Keep queued messages in arrival order.
...
- Development reloads and recoverable disconnects do not duplicate replies or lose accepted queued messages. Logout and connection replacement do not reconnect automatically.
